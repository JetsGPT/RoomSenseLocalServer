...
This directory contains all documentation for the RoomSense Local Server project.

## Main Documentation

- **SECURE_SETUP.md** - Complete guide to the Docker Swarm secrets system, including:
  - How the secure secrets management works
...
- **TESTING_BLE_SCAN.md** - BLE scanning testing guide
- **sensors-api-usage.md** - Sensors API usage documentation
